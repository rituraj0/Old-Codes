...
namespace details
{
    ...
    void* SubAllocator::Alloc(size_t numBytes)
    {
        ...
        pAllocationEntry->m_bucketIndex = (ULONG_PTR)Security::EncodePointer((PVOID)bucketIndex);
    ...
    void SubAllocator::Free(void* pAllocation)
    {
        ...
        int bucketIndex = (int) Security::DecodePointer((PVOID)pAllocationEntry->m_bucketIndex);
