...
namespace details
{
    ...
    /// <summary>
    ///     Returns an indication as to whether a cancellation is occuring at the specified depth. The result here is normally only valid when
    ...
    /// </summary>
    _CRTIMP size_t & __cdecl _StackGuard::_GetCurrentInlineDepth()
    {
