...
namespace details
{
    ...
    void ScheduleGroupSegmentBase::ScheduleTask(_In_ TaskProc proc, void* data)
    {
        ...
        if (pCurrentContext == NULL || pCurrentContext->GetScheduler() != pScheduler)
        {
            ...
            //
            ExternalStatistics * externalStatistics = (ExternalStatistics *) TlsGetValue(pScheduler->m_dwExternalStatisticsIndex);
            ...
            if (externalStatistics == NULL)
            {
                ...
                TlsSetValue(pScheduler->m_dwExternalStatisticsIndex, externalStatistics);
            }
            else
            {
                //
