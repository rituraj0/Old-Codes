[!if DLL_APP]
// [!output PROJECT_NAME].cpp : Defines the exported functions for the DLL application.
[!endif]
[!if WIN_APP]
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_[!output UPPER_CASE_SAFE_PROJECT_IDENTIFIER_NAME], szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_[!output UPPER_CASE_SAFE_PROJECT_IDENTIFIER_NAME]));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_[!output UPPER_CASE_SAFE_PROJECT_IDENTIFIER_NAME]);
...
// see [!output PROJECT_NAME].h for the class definition
