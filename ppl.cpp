...
namespace details
{
    ...
    _CRTIMP2 unsigned int _GetNextAsyncId()
    {
        //
        ...
        //
        return static_cast<unsigned int>(InterlockedIncrement(reinterpret_cast<volatile LONG *>(&s_asyncId)));
    }
...
/// </summary>
_CRTIMP2 bool is_task_cancellation_requested()
{
    return Context::IsCurrentTaskCollectionCanceling();
}

_CRTIMP2 void cancel_current_task()
{
    throw task_canceled();
}
